<<<<<<< HEAD:Network_Communication_PoC/App/src/app.c
/*
*********************************************************************************************************
*                                             EXAMPLE CODE
*********************************************************************************************************
...
static  void  AppStartTask (void  *p_arg)
{
    ...
    Ex_NetIF_CfgDflt_Ether.IPv4.Static.Addr = "10.1.10.9";  // server add
  // Ex_NetIF_CfgDflt_Ether.IPv4.Static.Addr = "10.1.10.10";    // client add
   ...
   // AppClientInit(if_nbr); /* Initialize the client task */
    AppServerInit(if_nbr); /* Initialize the server task */
  ...
  // ETH->NETWORKCTRL = ETH_NETWORKCTRL_PTPUNICASTEN | 0x01;                                      /**< Enable detection of unicast PTP unicast frames. */
    //ETH->NETWORKCTRL =
...
>>>>>>> 7f1df31955ae36ee8c256083500d710a744bb435:PoC/App/src/app.c
