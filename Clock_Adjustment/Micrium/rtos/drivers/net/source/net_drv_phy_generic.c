...
*
* File : net_drv_phy_generic.c
*********************************************************************************************************
* Note(s) : (1) The (R)MII interface port is assumed to be part of the host EMAC.  Therefore, (R)MII
...
*
*           (2) Interrupt support is Phy specific, therefore the generic Phy driver does NOT support
...
*
*           (3) Does NOT support 1000Mbps Phy.
*********************************************************************************************************
*/
