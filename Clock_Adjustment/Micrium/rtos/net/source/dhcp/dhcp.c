...
*
* Description : Retrieve the dictionary entry associated with the given DHCP option code.
*
* Argument(s) : code    DHCP option code
*
* Return(s)   : Pointer to dictionary entry, if no errors.
*               DEF_NULL, otherwise
*
* Note(s)     : none.
*********************************************************************************************************
