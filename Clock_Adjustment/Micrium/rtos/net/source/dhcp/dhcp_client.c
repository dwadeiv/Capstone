...
#include  <rtos/net/include/dhcp.h>
#include  <rtos/net/include/net_util.h>
#include  <rtos/net/include/net_arp.h>
#include  <rtos/net/include/net_sock.h>

#include  <rtos/net/include/net_type.h>

#include  <rtos/net/source/dns/dns_client_priv.h>
...
*                                            DHCPc_IF_Add()
*
* Description : Attaches an interface to the DHCP module and starts the DHCP process on this interface.
*
* Argument(s) : if_nbr  Interface number on which DHCP must be perform.
*
*               p_cfg   Pointer to DHCP configuration for the given interface.
*
...
*                                           DHCPc_IF_Remove()
*
* Description : Stops and removes the DHCP operation on the given network interface.
*
* Argument(s) : if_nbr  Interface number on which DHCP process must be stopped.
*
*               p_err   Pointer to the variable that will receive one of the following error
*                       code(s) from this function:
*
...
*                                           DHCPc_IF_Reboot()
*
* Description : Reboots the DHCP Client process.
*
* Argument(s) : if_nbr  Interface number on which DHCP process must be rebooted.
*
*               p_err   Pointer to the variable that will receive one of the following error
*                       code(s) from this function:
*
...
* Return(s)   : None.
*
* Note(s)     : (1) The reboot process will be done automatically by the DHCP client process when an
...
*                                           DHCPc_Init()
*
* Description : Initializes the DHCP Client Module.
*
* Argument(s) : task_handle     The Service task handle which to attach the DHCP Client module.
*
...
*                                        DHCPc_HookOnStart()
*
* Description : The start process hook function for the DHCP Network Service Task Child.
*
* Argument(s) : p_child         Pointer to the DHCP Client Network Service Task Child.
*
*               p_err           Error pointer.
*
* Return(s)   : None.
...
*                                        DHCPc_HookOnStop()
*
* Description : The stop process hook function for the DHCP Network Service Task Child.
*
* Argument(s) : p_child     Pointer to the DHCP Client Network Service Task Child.
*
*               p_err       Error pointer.
...
*                                         DHCPc_HookOnMsg()
*
* Description : The hook function for a message received  by the Network Service Task and to be process
...
*
*               p_msg_arg   Pointer to the message arguments.
*
*               p_err       Error Pointer.
*
* Return(s)   : None.
...
*                                         DHCPc_HookOnErr()
*
* Description : The error process hook function for the DHCP Client Network Service Task Child.
*
* Argument(s) : p_child     Pointer to the DHCP Client Network Service Task Child.
*
*               p_err       Error pointer.
...
*                                          DHCPc_ObjAdd()
*
* Description : Add an DHCPc-Interface object to the global list.
*
* Argument(s) : p_obj   Pointer to the DHCPc object to add to the list.
*
*               p_err   Error pointer.
*
* Return(s)   : None.
...
*                                         DHCPc_ObjRemove()
*
* Description : Remove an DHCPc-Interface object from the global list.
*
* Argument(s) : p_obj   Pointer to the DHCPc object to remove from the list.
*
*               p_err   Error pointer.
*
* Return(s)   : None.
...
*                                       DHCPc_HookOnSockRx()
*
* Description : The Hook function called when data is received on the socket associated with the
*               DHCP client process.
*
* Argument(s) : p_child     Pointer to the DHCP Client Network Service Task Child.
*
*               sock_id     Socket ID for the DHCP Client process.
*
*               p_arg       Pointer to context arguments.
*
*               p_err       Error pointer.
*
* Return(s)   : None.
...
*                                       DHCPc_HookOnSockTx()
*
* Description : The Hook function called when the socket associated with the DHCP client process is ready
*               to transmit.
*
* Argument(s) : p_child     Pointer to the DHCP Client Network Service Task Child.
*
...
*                                       DHCPc_HookOnSockErr()
*
* Description : The Hook function called when an error occurred on the socket associated with the DHCP
*               client.
*
* Argument(s) : p_child         Pointer to the DHCP Client Network Service Task Child.
*
*               sock_id         Socket ID for the DHCP Client process.
*
*               p_dhcpc_obj     Pointer to current DHCPc-Interface object.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*                                     DHCPc_HookOnTmrTimeout()
*
* Description : The hook function for a timed out timer by the Network Service Task and to be process
*               by the DHCP client child.
*
* Argument(s) : p_child         Pointer to the DHCP Client Network Service Task Child.
*
...
*                                       DHCPc_StartHandler()
*
* Description : Do the operations required by the DHCP process to start properly.
*
* Argument(s) : p_child     Pointer to the DHCP Client Network Service Task Child.
*
*               p_obj       Pointer to current DHCPc-Interface object.
*
*               p_err       Error pointer.
*
* Return(s)   : None.
...
*                                         DHCPc_RetryHandler()
*
* Description : Retry the DHCP client process after declining the offer or receiving a NACK message.
*
* Argument(s) : p_child     Pointer to the DHCP Client Network Service Task Child.
*
*               p_obj       Pointer to current DHCPc-Interface object.
...
*                                        DHCPc_StopHandler()
*
* Description : Stop the DHCP process for the given DHCPc-Interface object.
*
* Argument(s) : p_child     Pointer to the DHCP Client Network Service Task Child.
*
*               p_obj       Pointer to current DHCPc-Interface object.
...
*                                        DHCPc_FailHandler()
*
* Description : (1) Operations required when the DHCP Client process fails:
...
*               p_obj       Pointer to current DHCPc-Interface object.
*
*               err         Error object with the error code that caused the fail.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*                                         DHCPc_RemoveHandler()
*
* Description : Stop the DHCP process and remove the DHCP object from the list.
*
* Argument(s) : p_child     Pointer to the DHCP Client Network Service Task Child.
*
*               p_obj       Pointer to current DHCPc-Interface object.
*
*               p_err       Error object with the error code that caused the fail.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*                                        DHCPc_TmrHandler()
*
* Description : DHCP Client process after a timer timed out.
*
* Argument(s) : p_child     Pointer to the DHCP Client Network Service Task Child.
*
*               p_obj       Pointer to current DHCPc-Interface object.
...
*                                           DHCPc_InitSock()
*
* Description : Initialize and open a new socket for the DHCP Client process.
*
* Argument(s) : p_child         Pointer to the DHCP Client Network Service Task Child.
*
*               p_cfg           Pointer to the DHCP configuration.
*
*               p_err           Error pointer.
*
* Return(s)   : ID for the new socket to use, if no errors.
...
*                                         DHCPc_SockSetTx()
*
* Description : Configure the network socket before transmission.
*
* Argument(s) : p_obj           Pointer to current DHCPc-Interface object.
*
*               ip_addr_local   IPv4 address to use as source address for transmission.
*
*               p_err           Error pointer
*
* Return(s)   : None.
...
*                                           DHCPc_SockSetRx()
*
* Description : Set the DHCP socket to bind to the any address for reception purposes.
*
* Argument(s) : p_obj   Pointer to current DHCPc-Interface object.
*
*               p_err   Error pointer
...
*                                        DHCPc_PrepareTx()
*
* Description : Prepare for the DHCP message transmission.
*
* Argument(s) : p_child     Pointer to the DHCP Client Network Service Task Child.
*
*               p_obj       Pointer to current DHCPc-Interface object.
...
*
* Description : Prepare the DHCP process for a transmit retry of the DHCP message.
*
* Argument(s) : p_child     Pointer to the DHCP Client Network Service Task Child.
*
*               p_obj       Pointer to current DHCPc-Interface object.
...
*                                        DHCPc_PrepareMsg()
*
* Description : Prepare the DHCP message to send.
*
* Argument(s) : p_obj           Pointer to current DHCPc-Interface object.
*
*               msg_type        DHCP message type.
*
*               p_msg_buf       Pointer to the message buffer to fill.
*
*               msg_buf_size    Size of the message buffer.
*
*               p_err           Error pointer.
*
* Return(s)   : Length of the DHPC message, if no errors.
*               0, otherwise.
*
* Note(s)     : None.
*********************************************************************************************************
...
*                                         DHCPc_RxHandler()
*
* Description : Process a received DHCP message.
*
* Argument(s) : p_child     Pointer to the DHCP Client Network Service Task Child.
*
*               sock_id     Socket ID used to received data.
*
*               p_obj       Pointer to current DHCPc-Interface object.
*
*               p_msg       Pointer to the received message object.
*
*               p_err       Error pointer.
*
* Return(s)   : The status of the DHCP Client process. See enum DHCPc_STATUS
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*                                          DHCPc_RxOffer()
*
* Description : Process a received DHCP Offer message.
*
* Argument(s) : p_obj   Pointer to current DHCPc-Interface object.
*
*               p_msg   Pointer to the received message object.
...
*                                           DHCPc_RxACK()
*
* Description : Process a received DHCP ACK message.
*
* Argument(s) : p_child     Pointer to the DHCP Client Network Service Task Child.
*
*               p_obj       Pointer to current DHCPc-Interface object.
...
*                                          DHCPc_RxSock()
*
* Description : Received DHCP message with socket API.
*
* Argument(s) : sock_id     Socket ID on which data is received.
*
*               p_msg       Pointer to DHCPc message object that will be filled with data received.
*
*               p_err       Error pointer.
*
* Return(s)   : None.
...
*                                        DHCPc_RxValidate()
*
* Description : Check that the received packet is a valid DHCP message.
*
* Argument(s) : sock_id     Socket ID.
*
*               p_obj       Pointer to current DHCPc-Interface object.
*
*               p_msg       Pointer to received message.
*
*               p_err       Error pointer.
*
* Return(s)   : DEF_YES, if message received is valid.
*               DEF_NO,  otherwise.
*
* Note(s)     : None.
*********************************************************************************************************
...
*                                         DHCPc_TxHandler()
*
* Description : Process DHCP message to send.
*
* Argument(s) : p_child     Pointer to the DHCP Client Network Service Task Child.
*
*               sock_id     Socket ID to used.
*
*               p_obj       Pointer to current DHCPc-Interface object.
*
*               p_err       Error pointer.
...
*                                          DHCPc_TxSock()
*
* Description : Transmit DHCP message with socket API.
*
* Argument(s) : sock_id     Socket ID on which to send the message.
*
*               p_obj       Pointer to current DHCPc-Interface object.
*
*               p_err       Error pointer.
...
*
*               p_msg_buf           Pointer to DHCP message buffer to search.
*
*               msg_buf_size        Size of message buffer (in octets).
*
*               p_opt_val_len       Pointer to variable that will receive the length of the option value.
*
...
*                                       DHCPc_LeaseTimeCalc()
*
* Description : Calculate the DHCP Lease Time for the IP address.
*
* Argument(s) : p_obj       Pointer to DHCPc-Interface object.
*
*               p_msg       Pointer to the DHCP message received.
*
*               p_err       Error Pointer.
*
* Return(s)   : None.
...
*                                       DHCPc_AddrValidate()
*
* Description : Check if the IPv4 address already exist on the network by sending ARP messages.
*
* Argument(s) : p_obj       Pointer to DHCPc-Interface object.
*
*               p_err       Error pointer.
*
* Return(s)   : DEF_YES, address is valid because is unique on the local network.
*               DEF_NO,  otherwise.
*
* Note(s)     : None.
*********************************************************************************************************
...
*                                       DHCPc_LinkSubscribe()
*
* Description : Hook function for DHCP client process when the Interface link state changes.
*
* Argument(s) : if_nbr      Interface number on which link state changed
*
*               link_state  Current link state of interface.
*
* Return(s)   : None.
*
* Note(s)     : None.
