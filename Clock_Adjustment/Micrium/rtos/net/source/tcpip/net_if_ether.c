...
*                                           NetIF_Ether_Add()
*
* Description : Add & initialize a specific instance of a network Ethernet interface.
*
* Argument(s) : p_name      String identifier for the Ethernet interface to add.
*
*               p_buf_cfg   Pointer to buffer configuration (See Note #1).
*
...
*
* Note(s)     : (1) When a non null buffer configuration is passed, a copy of the device configuration
                             ...
                             RTOS_ERR        *p_err)
{
    ...
    if (p_buf_cfg != DEF_NULL) {
        ...
        Mem_Copy(p_dev_cfg_valid, p_dev_cfg, sizeof(p_dev_cfg_valid));
...
*                                          NetIF_Ether_Start()
*
* Description : (1) Start an Ethernet type interface :
*
...
*
*               p_cfg   Pointer to interface configuration.
...
*                                           NetIF_Ether_Reg()
*
* Description : Register an Ethernet Interface at the Platform Manager.
*
* Argument(s) : p_name          String identifier for the Ethernet interface to register.
*
*               p_ctrlr_info    Pointer to the Ethernet controller information structure.
*
*               p_err           Pointer to the variable that will receive one of the following error
*                               code(s) from this function:
*
                                          ...
                                          RTOS_ERR    *p_err)
{
    ...
    switch (opt) {
        ...
        case NET_IF_IO_CTRL_LINK_STATE_UPDATE:
             break;                                             /* Rtn err for unavail ctrl opt?                        */
