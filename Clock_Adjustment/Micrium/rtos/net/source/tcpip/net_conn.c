...
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) [INTERNAL] 'NetConn_AccessedTh_nbr' MUST ALWAYS be accessed exclusively in
*                   critical sections.
*********************************************************************************************************
*/
...
*
* Note(s)     : (1) [INTERNAL] 'NetConn_PoolStat' MUST ALWAYS be accessed exclusively in critical sections.
*********************************************************************************************************
*/
...
*                                         NetConn_IsPortUsed()
*
* Description : Check if the given port number is the one of an already used port.
*
* Argument(s) : port_nbr    Port number to check.
*
...
*
* Return(s)   : DEF_YES, if port is used,
*               DEF_NO, otherwise.
*
* Note(s)     : none.
*********************************************************************************************************
