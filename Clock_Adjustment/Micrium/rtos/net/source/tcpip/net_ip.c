...
*
* Argument(s) : p_mem_seg   Pointer to memory segment use for allocation
*
*               p_err       Error pointer
*
* Return(s)   : none.
...
*
*               p_mem_seg   Pointer to memory segment use for allocation
*
...
*                                          NetIP_IsAddrCfgd()
*
* Description : Check if an IP address is configured on the given network interface.
*
* Argument(s) : if_nbr  Network Interface number
*
*               p_addr  Pointer to IP address
*
*               p_err   Pointer to variable that will receive the return error code from this function.
*
* Return(s)   : DEF_YES, if address is configured.
*               DEF_NO, otherwise.
*
* Note(s)     : none.
*********************************************************************************************************
...
*
*               addr_type   $$$$ Add description for 'addr_type'
*
...
* Description : $$$$ Add function description.
*
* Argument(s) : addr_type   $$$$ Add description for 'addr_type'
*
*               p_addr      $$$$ Add description for 'p_addr'
*
*               addr_len    $$$$ Add description for 'addr_len'
*
* Return(s)   : $$$$ Add return value description.
*
* Note(s)     : none.
...
* Argument(s) : if_nbr                      $$$$ Add description for 'if_nbr'
*
*               protocol_type               $$$$ Add description for 'protocol_type'
*
*               p_addr_protocol_tbl         $$$$ Add description for 'p_addr_protocol_tbl'
*
*               p_addr_protocol_tbl_qty     $$$$ Add description for 'p_addr_protocol_tbl_qty'
*
*               p_addr_protocol_len         $$$$ Add description for 'p_addr_protocol_len'
*
*               p_err                       $$$$ Add description for 'p_err'
*
* Return(s)   : $$$$ Add return value description.
...
*
* Description : Get the interface number for a host's IP address.
*
* Argument(s) : addr_type   IP address family:
*
*                               NET_IP_ADDR_FAMILY_IPv4
*                               NET_IP_ADDR_FAMILY_IPv6
*
*               p_addr      Pointer to host's IP address.
*
*               addr_len    Length of the host's IP address
*
*               p_err       Pointer to variable that will receive the return error code from this function.
*
* Return(s)   : The interface number on which the host IP address is configured.
