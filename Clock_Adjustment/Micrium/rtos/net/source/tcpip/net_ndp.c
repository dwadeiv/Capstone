...
*               DEF_FAIL, otherwise.
*
* Note(s)     : [INTERNAL] 'NetNDP_NeighborCacheTimeout_ms' variables MUST ALWAYS be accessed exclusively
...
*
*
* Argument(s) : p_err   Pointer to error variable.
*
* Return(s)   : none.
*
* Note(s)     : none.
...
*
*               p_addr_nexthop  Pointer to variable that will receive the next hop IPv6 address.
*
*               p_err           Pointer to variable that will receive the return error code from this function.
*
...
*               p_addr_dest     Pointer to IPv6 destination address.
*
*               p_addr_nexthop  Pointer to variable that will received the next-hop ipv6 address.
*
*               p_err           Pointer to variable that will receive the return error code from this function.
*
* Return(s)   : Destination status
*
...
*
* Description : Search for an invalid destination cache entry in the destination cache and remove it from
*               the list.
*
* Argument(s) : p_err       Pointer to variable that will receive the return error code from this function:
*
