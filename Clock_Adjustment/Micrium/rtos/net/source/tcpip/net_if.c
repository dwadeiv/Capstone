...
*
* Description : Get network interface number from it's name.
*
* Argument(s) : p_name    Pointer to a string containing interface controller's name.
*
* Return(s)   : Network interface number associated with controller name.
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
*
* Description : Wait for the interface setup to be complete after a call to NetIF_xxx_Start().
*
* Argument(s) : if_nbr      Network interface number on which to wait.
*
*               p_info      Pointer to structure in which the setup information will be copied.
*                           DEF_NULL, to not receive the setup information.
*
*               timeout_ms  Timeout value after which the function will stop waiting, in milliseconds.
...
*                                              NetIF_Add()
*
* Description : Add & initialize a specific instance of a network interface.
*
...
*
*               (2) (a) Network physical layer arguments MAY be NULL for any of the following :
*
...
*                   asynchronous to other network protocol tasks.
*
*               (3) [INTERNAL] Each specific network interface 'Start()' is responsible for setting the
...
*                   asynchronous to other network protocol tasks.
*
*               (2) [INTERNAL] Each specific network interface 'Stop()' SHOULD be responsible for clearing
...
*
* Description : Configure Network Interface Physical Link State Handler time (i.e. scheduling period).
*
...
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) Configured time does NOT reschedule the next physical link state handling but
*                   configures the scheduling of all subsequent  physical link state handling.
*
*               (2) [INTERNAL] 'NetIF_DataPtr->PhyLinkStateTime_ms' variables MUST ALWAYS be accessed exclusively
...
*
* Description : Configure Network Interface Performance Monitor Handler time (i.e. scheduling period).
*
...
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) Configured time does NOT reschedule the next performance monitor handling but
*                   configures the scheduling of all  subsequent performance monitor handling.
*
*               (2) [INTERNAL] 'NetIF_DataPtr->PerfMonTime_ms' variables MUST ALWAYS be accessed exclusively
*                   in critical sections.
*********************************************************************************************************
*/
...
*
* Description : Get aligned pointer into a receive application data buffer.
*
...
*                   asynchronous to other network protocol tasks.
*
*               (2) (a) (1) (A) Optimal alignment between application data buffer(s) & network interface's
...
*
* Description : Get aligned pointer into a transmit application data buffer.
*
...
*                                            NetIF_TypeGet()
*
* Description : Get the network interface type from the interface number.
*
...
*                           RTOS_ERR_INVALID_HANDLE
*
* Return(s)   : Network Interface type:
*
*                       NET_IF_TYPE_ETHER
*                       NET_IF_TYPE_WIFI
...
*
*               p_addr_len  Pointer to a variable that will receive the address length.
*
*               p_err       Pointer to variable that will receive the return error code from this function :
*
*                               RTOS_ERR_NONE
...
*
*               p_addr_hw   Pointer to an interface hardware address.
*
*               p_err       Pointer to variable that will receive the return error code from this function :
*
*                               RTOS_ERR_NONE
...
*                                         NetIF_LinkStateGet()
*
* Description : Get network interface's last known physical link state.
*
...
*
*               retry_max       Maximum number of consecutive wait retries.
*
*               time_dly_ms     Transitory delay value, in milliseconds.
*
*               p_err           Pointer to variable that will receive the return error code from this function :
*
*                                   RTOS_ERR_NONE
...
*
*               p_data  Pointer to variable that will receive possible I/O control data.
*
*               p_err   Pointer to variable that will receive the return error code from this function :
*
*                           RTOS_ERR_NONE
...
* Return(s)   : none.
*
* Note(s)     : (1) [INTERNAL] 'NetIF_TxSuspendTimeout_tick' variables MUST ALWAYS be accessed exclusively
*                   in critical sections.
*********************************************************************************************************
*/
...
* Return(s)   : none.
*
* Note(s)     : (1) Device driver(s)' Board Support Package (BSP) Interrupt Service Routine (ISR) handler(s).
...
*
*               (2) [INTERNAL] This function is called by device driver function(s) & :
*
*                   (a) MUST NOT be called with the global network lock already acquired;
...
*
*               (3) [INTERNAL] Network device interrupt service routines (ISR) handler(s) SHOULD be able to
...
*                                         NetIF_StartInternal()
*
* Description : Start network interface with given setup structure.
*
* Argument(s) : if_nbr  Network interface number.
*
*               p_cfg   Pointer to configuration structure for the interface setup.
*
*               p_err   Pointer to variable that will receive the return error code from this function.
*
* Return(s)   : None.
...
*
* Return(s)   : Maximum received payload.
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
*                                           NetIF_RxQPost()
*
* Description : Signal that a new packet was received by adding an event in the RX event list.
*
* Argument(s) : if_nbr      Network interface on which packet was received.
*
*               p_err       Pointer to variable that will receive the return error code from this function.
*
* Return(s)   : none.
*
* Note(s)     : (1) This function is a network protocol suite to network device function & SHOULD be called
...
*                                          NetIF_RxQPend()
*
* Description : Check for a received packet event in the Rx event list.
*
* Argument(s) : p_err       Pointer to variable that will receive the return error code from this function.
*
* Return(s)   : Interface number on which packet was received, if NO error(s).
*               NET_IF_NBR_NONE, otherwise.
*
* Note(s)     : none.
*********************************************************************************************************
...
*               ------      Argument validated in NetIF_RxQPost().
*
* Return(s)   : none.
*
...
* Argument(s) : if_nbr          Interface number that received packet(s).
*
*               rx_chk_nbr      Number of consecutive times that network interface's receive packet
...
*
* Description : Signal that a new buffer is ready to be de-allocated by adding an event in the TX event list.
...
*
* Description : Check for a buffer transmitted to be deallocated in the Tx event list.
*
* Argument(s) : p_err   Pointer to variable that will receive the return error code from this function.
*
...
* Return(s)   : none.
*
* Note(s)     : (1) This function is a network interface (IF) to network device function & SHOULD (optionally)
...
*
* Argument(s) : p_if  Pointer to interface to signal transmit ready.
*
* Return(s)   : none.
*
* Note(s)     : (1) This function is a network interface (IF) to network device function & SHOULD be called
*                   only by appropriate network device driver function(s).
*
*               (2) Device transmit ready MUST be signaled--i.e. MUST signal without failure.
*
...
*                                         NetIF_Q_Update()
*
* Description : When a new interface is added, this function adds new events to the Rx and Tx Free Event Lists.
*               The number of new events depends on the number of Rx and Tx buffers configured in
*               the device configuration.
*
* Argument(s) : p_mem_seg   Pointer to memory segment to use to allocate the object for the Rx & Tx Q.
*                           DEF_NULL to use the configured HEAP memory.
*
*               nbr_rx      Number of events to add in the Free Rx event list.
*
*               nbr_tx      Number of events to add in the Free Tx event list.
*
*               p_err       Pointer to variable that will receive the return error code from this function.
*
* Return(s)   : none.
...
*
*                   (b) If timeout      desired, return RTOS_ERR_TIMEOUT error on transmit
...
* Return(s)   : none.
*
* Note(s)     : (2) 'p_data' MUST point to a variable or memory buffer that is sufficiently sized AND
...
*
* Description : Interface hook function for IPv4 link-local address process ending.
*
* Argument(s) : if_nbr              Interface number.
*
*               link_local_addr     IPv4 Link-local address configured, if any.
...
*
*               err                 Error code if error during the IPv4 link-local process.
...
*
* Description : Interface hook function for DHCP client process ending.
*
* Argument(s) : if_nbr      Interface number.
*
...
*                           NET_IPv4_ADDR_NONE, otherwise.
*
*               mask        IPv4 address mask for address configured, if any.
*                           NET_IPv4_ADDR_NONE, otherwise.
*
*               gateway     IPv4 address gateway for address configured, if any.
*                           NET_IPv4_ADDR_NONE, otherwise.
*
*               err         Error code if error during the DHCP process.
*                           RTOS_ERR_NONE, otherwise.
*
* Return(s)   : None.
*
...
*                                         NetIF_IPv6_AddrHook()
*
* Description : Interface hook function for IPv6 address configuration process.
*
* Argument(s) : if_nbr              Interface number.
*
...
*                                   DEF_NULL, otherwise.
*
*               addr_cfg_status     Status of the IPv6 address configuration process:
*
...
*
* Description : Hook function for network interface link up associated with the network interface start
*               setup wait feature.
*
* Argument(s) : if_nbr      Network interface number.
*
*               link_state  Network interface link state:
*
*                               NET_IF_LINK_UP
*                               NET_IF_LINK_DOWN
*
...
*                                          NetIF_ValidateAPI()
*
* Description : Validate if there is no Null pointer in the interface API.
*
* Argument(s) : p_if_api    Pointer to the Interface API to validate
*
*               type        Interface type
*
*                               NET_IF_TYPE_NONE
