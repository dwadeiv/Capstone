...
//static  const  OP_LOCK_OP_DESC  NetSvcTask_OpLockSockListWr =
//{
//   .policy =
//};
//
//static  const  OP_LOCK_OP_DESC  NetSvcTask_OpLockSockListRd =
//{
//};
//
//static  const  OP_LOCK_OP_DESC  NetSvcTask_OpLockMsgListWr =
//{
//};
//
//static  const  OP_LOCK_OP_DESC  NetSvcTask_OpLockTmrListRd =
//{
//};
//
//static  const  OP_LOCK_OP_DESC  NetSvcTask_OpLockTmrListRd =
...
*                                           NetSvcTask_Init()
*
* Description : Initialize the Network Service Task module.
*
* Argument(s) : p_task_cfg  Pointer to task configuration.
*
...
*
* Return(s)   : The Network Service Task handle.
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*                                          NetSvcTask_Start()
*
* Description : Start the service task associated with the given handle.
*
* Argument(s) : task_handle     Service task handle of task to start.
*
*               p_err           Pointer to variable that will receive the return error code from this function.
*
* Return(s)   : None.
...
*                                           NetSvcTask_Stop()
*
* Description : Stop the service task associated with the given handle.
*
* Argument(s) : task_handle     Service task handle of task to stop
*
*               p_err           Pointer to variable that will receive the return error code from this function.
*
* Return(s)   : None.
...
*                                         NetSvcTask_PrioSet()
*
* Description : Sets priority of the network service task.
*
* Argument(s) : task_handle     Service task handle.
*
*               prio            Priority of the network service task.
*
*               p_err           Pointer to variable that will receive the return error code from this function.
*
* Return(s)   : None.
...
*
* Description : Create and start a service task's child.
*
* Argument(s) : task_handle     Task handle on which the child will be attached.
*
*               p_child_cfg     Pointer to the child configuration.
*
*               p_child_data    Pointer to specific data for the child.
*
*               p_hooks         Pointer to set of hook functions for the child.
*
*               p_err           Pointer to variable that will receive the return error code from this function.
*
* Return(s)   : Pointer to the new child.
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*
* Description : Stop a service task's child.
*
* Argument(s) : p_child     Pointer to the child.
*
*               p_err       Pointer to variable that will receive the return error code from this function.
*
* Return(s)   : None.
...
*
* Description : Send a message to a specific service task's child.
*
* Argument(s) : p_child             Pointer to child.
*
*               child_msg_type      Message type specific to the child.
*
*               p_child_msg_arg     Pointer to message argument.
*
*               block               DEF_YES, the function will wait for the message processing end.
*                                   DEF_NO,  otherwise.
*
*               p_err               Pointer to variable that will receive the return error code from this function.
*
...
*
* Description : Create new timer for given service task's child.
*
* Argument(s) : p_child     Pointer to service task's child.
*
*               type        Timer type :
*
...
*
*               fnct        Timeout callback function of timer.
*
*               p_arg       Pointer to object to pass as argument in the timeout callback.
*
*               timeout_ms  Timeout value of timer.
*
*               p_err       Pointer to variable that will receive the return error code from this function.
*
* Return(s)   : Timer handle.
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*                                          NetSvcTask_TmrSet()
*
* Description : Set the value of a already existing service task's timer.
*
* Argument(s) : tmr_handle  Timer handle.
*
*               fnct        Timeout callback function of timer.
*
*               p_arg       Pointer to object to pass as argument in the timeout callback.
...
*                                          NetSvcTask_TmrDel()
*
* Description : Delete a service task's timer.
*
* Argument(s) : tmr_handle    Timer handle.
*
*               p_err         Pointer to variable that will receive the return error code from this function.
...
*
* Description : Open a network socket for a client type application.
*
* Argument(s) : p_child             Pointer to service task's child.
*
*               protocol_family     Socket protocol family :
*
...
*
*               p_addr_bind         Pointer to socket address structure containing the address to bind to.
*
*               addr_len            Length  of socket address structure (in octets).
*
*               p_err               Pointer to variable that will receive the return error code from this function.
*
* Return(s)   : Network socket ID, if no errors.
...
*
* Description : Open a network socket for a server type application.
*
* Argument(s) : p_child             Pointer to service task's child.
*
*               protocol_family     Socket protocol family :
...
*               addr_len            Length  of socket address structure (in octets).
*
*               sock_q_size         Size of the Listen Q for the server type socket.
*
*               p_err               Pointer to variable that will receive the return error code from this function.
*
* Return(s)   : Network socket ID, if no errors.
...
*
* Description : Create a new service task socket handle for a child to associate with an existing network
*               socket.
*
* Argument(s) : p_child         Pointer to service task's child.
*
*               sock_id         Network socket id to attach the handle to.
*
*               type            Socket operation type for the socket :
*
...
*
*               rx_hook         Reception hook.
*
*               tx_hook         Transmission hook.
*
*               err_hook        Error hook.
*
*               p_hook_args     Pointer to object to pass as argument in hooks.
*
*               p_err           Pointer to variable that will receive the return error code from this function.
*
* Return(s)   : Pointer to socket handle, if no errors.
*               DEF_NULL, otherwise.
*
* Note(s)     : None.
*********************************************************************************************************
...
*
* Description : Change the socket operation type for the given service task's socket handle.
*
* Argument(s) : p_svc_task_sock     Pointer to service task's socket.
*
*               type                New value of the socket operation type :
*
*                                       NET_SVC_TASK_SOCK_OP_TYPE_RX_RDY
*                                       NET_SVC_TASK_SOCK_OP_TYPE_RX_DATA
*                                       NET_SVC_TASK_SOCK_OP_TYPE_TX_RDY
...
* Return(s)   : None.
*
* Note(s)     : TODO_NET no really need for a function, maybe macro
*********************************************************************************************************
*/
...
*
* Description : Delete a service task's socket on a specific child.
*
* Argument(s) : p_child             Pointer to service task's child.
*
*               p_svc_task_sock     Pointer to service task's socket.
*
*               p_err               Pointer to variable that will receive the return error code from this function.
*
* Return(s)   : None.
...
*                                             NetSvcTask()
*
* Description : Service task main loop.
*
* Argument(s) : p_arg   Pointer to task argument.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*                                          NetSvcTask_Pend()
*
* Description : Pend for signal from a new message, new timer or socket operations.
*
* Argument(s) : p_ctx           Pointer to service task context data.
*
*               p_sock_rd       Pointer to socket descriptor for read operations (RX).
*
*               p_sock_wr       Pointer to socket descriptor for write operations (TX).
*
*               p_sock_err      Pointer to socket descriptor for error check.
*
*               p_sock_rdy_ctn  Pointer to variable that will receive the number of sockets ready.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*                                          NetSvcTask_WakeUp()
*
* Description : Wake up service task by posting semaphore.
*
* Argument(s) : p_ctx   Pointer to the service task context.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*
* Description : Post a message to a given service task.
*
* Argument(s) : p_ctx       Pointer to the service task context.
*
*               msg_type    Type of the message.
*
*               p_arg       Pointer to message data.
*
*               block       DEF_YES, the function will wait for the message processing end.
*                           DEF_NO,  otherwise.
*
...
*                                           NetSvcTask_Msg()
*
* Description : Process messages received by the service task.
*
* Argument(s) : p_ctx   Pointer to service task context data.
*
* Return(s)   : None.
...
*                                         NetSvcTask_ChildAdd()
*
* Description : Create and add a child to the given service task.
*
* Argument(s) : p_ctx       Pointer to service task context data.
*
*               p_msg_arg   Pointer to the message data.
*
*               p_err       Pointer to variable that will receive the return error code from this function.
*
* Return(s)   : None.
...
*
* Description : Process a message addressed to a specific child.
*
* Argument(s) : p_arg   Pointer to message data.
*
*               p_err   Pointer to the variable that will receive the error code from this function.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*                                           NetSvcTask_Tmr()
*
* Description : This function update the timer list at each iteration of the main loop.
*
* Argument(s) : p_ctx       Pointer to service task context data.
*
*               p_ts_prev   Pointer to variable that contains the previous TS and will receive the current
...
*
* Description : Get the milliseconds value elapse since last TS acquired in the timers processing.
*
* Argument(s) : p_ctx   Pointer to the current service task context data.
*
* Return(s)   : Milliseconds delta since last TS acquired in the timers processing.
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*
* Description : Get the smallest timeout value in the timer list or the maximum timeout value possible
...
*
* Description : Add a new timer to the timers list.
*
* Argument(s) : p_ctx   Pointer to service task context data.
*
*               p_tmr   Pointer to the new timer to add.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*
* Description : Remove a timer from the timers list.
*
* Argument(s) : p_ctx   Pointer to service task context data.
*
*               p_tmr   Pointer to the timer to remove.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*
* Description : Get a timer object from the service task's child timer pool.
*
* Argument(s) : p_child     Pointer to child.
*
*               p_err       Pointer to variable that will receive the return error code from this function.
*
* Return(s)   : Pointer to timer object, if no errors.
*               DEF_NULL, otherwise.
*
* Note(s)     : None.
*********************************************************************************************************
...
*
* Description : Open a socket in client mode for a service task's child.
*
* Argument(s) : p_arg   Pointer to the message received by the service task.
*
*               p_err   Pointer to the variable that will receive the error code(s) from this function.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*
* Description : Open a socket in server mode for a service task's child.
*
* Argument(s) : p_arg   Pointer to the message received by the service task.
*
*               p_err   Pointer to variable that will receive the return error code from this function.
...
*
* Description : Initialize the socket descriptors before the socket select operations.
*
* Argument(s) : p_ctx       Pointer to the service task context.
*
*               p_sock_rd   Pointer to a set of socket descriptors to check for available read operation(s).
*                           Will return the set of descriptors with the socket ready for read operation.
*
*               p_sock_wr   Pointer to a set of socket descriptors to check for available write operation(s).
*                           Will return the set of descriptors with the socket ready for write operation.
*
*               p_sock_err  Pointer to a set of socket descriptors to check for available error(s).
*                           Will return the set of descriptors for socket with errors.
*
* Return(s)   : Number of socket ready for read/write operations or with error.
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*                                           NetSvcTask_Sock()
*
* Description : Process all the sockets on a service task that are ready for operations.
*
* Argument(s) : p_ctx       Pointer to the service task context.
*
*               p_sock_rd   Pointer to a set of socket descriptors containing socket ready for read operation.
*
*               p_sock_wr   Pointer to a set of socket descriptors containing socket ready for write operation.
*
*               p_sock_err  Pointer to a set of socket descriptors containing socket with errors.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*                                         NetSvcTask_ObjsFree()
*
* Description : Free all the allocated objects of the given service task.
*
* Argument(s) : p_ctx    Pointer to the service task context.
*
* Return(s)   : None.
