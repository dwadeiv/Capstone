...
*
* Argument(s) : p_str_args  $$$$ Add description for 'p_str_args'
*
*               p_if_cfg    $$$$ Add description for 'p_if_cfg'
*
...
*                                          NetCmd_IF_Restart()
*
* Description : Command function to restart an Network interface.
*
* Argument(s) : argc            is a count of the arguments supplied.
*
*               p_argv          an array of pointers to the strings which are those arguments.
...
*
* Description : Get Rx large Buffer stat
*
* Argument(s) : argc            is a count of the arguments supplied.
*
*               p_argv          an array of pointers to the strings which are those arguments.
...
*
* Description : Get Tx large Buffer stat
*
* Argument(s) : argc            is a count of the arguments supplied.
*
*               p_argv          an array of pointers to the strings which are those arguments.
...
*
* Description : Get Tx small Buffer stat
*
* Argument(s) : argc            is a count of the arguments supplied.
*
*               p_argv          an array of pointers to the strings which are those arguments.
