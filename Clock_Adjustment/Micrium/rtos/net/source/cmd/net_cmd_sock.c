...
#include  <rtos/net/include/net_icmp.h>
...
#include  <rtos/net/include/net_buf.h>

#ifdef  NET_IPv4_MODULE_EN
#include  <rtos/net/source/tcpip/net_ipv4_priv.h>
#include  <rtos/net/include/net_igmp.h>
#endif
#ifdef  NET_IPv6_MODULE_EN
#include  <rtos/net/source/tcpip/net_ipv6_priv.h>
#include  <rtos/net/source/tcpip/net_ndp_priv.h>
#include  <rtos/net/include/net_mldp.h>
#endif
...
*
*               out_fnct        $$$$ Add description for 'out_fnct'
*
*               p_cmd_param     $$$$ Add description for 'p_cmd_param'
*
...
* Description : $$$$ Add function description.
*
* Argument(s) : p_cmd_arg       $$$$ Add description for 'p_str'
*
*               argc            $$$$ Add description for 'argc'
*
*               p_argv          $$$$ Add description for 'p_argv'
*
*               p_err           $$$$ Add description for 'p_err
...
* Description : $$$$ Add function description.
*
* Argument(s) : p_args    $$$$ Add description for 'p_args'
*
*               p_vals    $$$$ Add description for 'p_vals'
*
*               p_err     $$$$ Add description for 'p_err'
*
* Return(s)   : $$$$ Add return value description.
