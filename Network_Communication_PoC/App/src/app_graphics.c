...
static void AppGraphics_DrawLinkStatus(void)
{
    ...
    GLIB_drawString(&glibContext, msg, strlen(msg), 0, 70, false);
}
...
static void AppGraphics_DrawTxRxStatus(void)
{
	...
	// ETH->IENS |= ETH_IENS_PTPDLYREQFRMRX;
			 //| ETH_IENS_PTPSYNCFRMRX |ETH_IENS_PTPDLYREQFRMTX | ETH_IENS_PTPSYNCFRMTX | ETH_IENS_PTPPDLYREQFRMRX
	 //| ETH_IENS_PTPPDLYRESPFRMRX   | ETH_IENS_PTPPDLYREQFRMTX  | ETH_IENS_PTPPDLYRESPFRMTX | ETH_IENS_TSUSECREGINCR;
	    //ETH->NETWORKCTRL =
	//ETH->NETWORKCTRL |= _ETH_NETWORKCTRL_ONESTEPSYNCMODE_MASK;
    char str[20] = {0};
    static uint32_t framesTx = 0;
    static uint32_t framesRx = 0;

    static uint32_t  Timer_S= 1 ;        /**< 1588 Timer Seconds Register 31:0  */
    static uint32_t Timer_NS = 1;         /**< 1588 Timer Nanoseconds Register  */
    static uint32_t Timer_Incr= 1;        /**< 1588 Timer Increment Register  */
    static uint32_t EVT_TX_S=1;        /**< PTP Event Frame Transmitted Seconds Register 31:0  */
    static uint32_t EVT_TX_Ns= 1;        /**< PTP Event Frame Transmitted Nanoseconds Register  */
    static uint32_t Peer_EVT_TX_S= 1 ;    /**< PTP Peer Event Frame Transmitted Seconds Register 31:0  */
    static uint32_t Peer_EVT_TX_Ns= 1;       /**< PTP Peer Event Frame Transmitted Nanoseconds Register  */
    ...
    Timer_S= ETH-> TSUTIMERSEC;         /**< 1588 Timer Seconds Register 31:0  */
    Timer_NS= ETH-> TSUTIMERNSEC;        /**< 1588 Timer Nanoseconds Register  */
    Timer_Incr= ETH->TSUTIMERINCR;        /**< 1588 Timer Increment Register  */
    EVT_TX_S= ETH-> TSUPTPTXSEC;         /**< PTP Event Frame Transmitted Seconds Register 31:0  */
    EVT_TX_Ns= ETH-> TSUPTPTXNSEC;        /**< PTP Event Frame Transmitted Nanoseconds Register  */
//    Time_Stamp= ETH-> TSUPTPRXSEC;         /**< PTP Event Frame Received Seconds Register 31:0  */
//    Time_Stamp= ETH->  TSUPTPRXNSEC;        /**< PTP Event Frame Received Nanoseconds Register  */
    Peer_EVT_TX_S= ETH->  TSUPEERTXSEC;        /**< PTP Peer Event Frame Transmitted Seconds Register 31:0  */
    Peer_EVT_TX_Ns= ETH->  TSUPEERTXNSEC;       /**< PTP Peer Event Frame Transmitted Nanoseconds Register  */
//    Time_Stamp= ETH->  TSUPEERRXSEC;        /**< PTP Peer Event Frame Received Seconds Register 31:0  */
//    Time_Stamp= ETH->  TSUPEERRXNSEC;       /**< PTP Peer Event Frame Received Nanoseconds Register  */
...
//    snprintf(str, sizeof(str), "Timer RG s: %"PRIu32, Timer_S);
//    GLIB_drawString(&glibContext, str, strlen(str), 0, 70, false);
//
//    snprintf(str, sizeof(str), "Timer RG ns: %"PRIu32, Timer_NS);
//    GLIB_drawString(&glibContext, str, strlen(str), 0, 80, false);
//
//    snprintf(str, sizeof(str), "Timer Incr: %"PRIu32, Timer_Incr );
//    GLIB_drawString(&glibContext, str, strlen(str), 0, 90, false);
//
//    snprintf(str, sizeof(str), "EVT TX S: %"PRIu32, EVT_TX_S);
//    GLIB_drawString(&glibContext, str, strlen(str), 0, 100, false);
//
//    snprintf(str, sizeof(str), "EVT TX ns: %"PRIu32, EVT_TX_Ns);
//        GLIB_drawString(&glibContext, str, strlen(str), 0, 110, false);
//
//    snprintf(str, sizeof(str), "Peer EVT TX S: %"PRIu32, Peer_EVT_TX_S );
//            GLIB_drawString(&glibContext, str, strlen(str), 0, 120, false);
...
{
	 char str[20] = {0};
	 static uint32_t LED0 = 0;
	 static uint32_t LED1 = 0;

	LED0= BSP_LedGet(0);
	LED1= BSP_LedGet(1);

	 snprintf(str, sizeof(str), "LED0 Status: %"PRIu32, LED0);
	 GLIB_drawString(&glibContext, str, strlen(str), 0, 90, false);
	 snprintf(str, sizeof(str), "LED1 Status: %"PRIu32, LED1);
	 GLIB_drawString(&glibContext, str, strlen(str), 0, 100, false);
}
