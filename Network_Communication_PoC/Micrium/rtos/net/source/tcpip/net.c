...
#include  <rtos/net/include/net_conn.h>
...
#include  <rtos/net/include/net_ndp.h>
...
*
* Description : Configure the network core task stack properties to use the parameters contained in
...
* Return(s)   : None.
*
* Note(s)     : (1) This function is optional. If it is called, it must be called before Net_Init(). If
...
*
* Description : Configure the network core services task stack properties to use the parameters contained
...
*                                         Net_ConfigureMemSeg()
*
* Description : Configure the memory segment that will be used to allocate internal data needed by Net
...
*
* Description : Configure the DNS Client module parameters.
*
* Argument(s) : p_cfg   Pointer to the structure containing the new DNS client parameters.
*
* Return(s)   : None.
*
* Note(s)     : (1) This function is optional. If it is called, it must be called before Net_Init(). If
...
*                                             Net_Init()
*
* Description : Initialize network core TCP-IP module and task and if necessary the DNS and DHCP client
*               services.
*
* Argument(s) : p_err       Pointer to variable that will receive the return error code from
*                           this function:
*
*                               RTOS_ERR_NONE
*                               RTOS_ERR_NOT_AVAIL
...
* Return(s)   : none.
*
* Note(s)     : (1) NetInit() MUST be called :
*
...
*
*               (2) If any network initialization error occurs, any remaining network initialization
...
*
* Argument(s) : prio        New priority for the network core task.
*
...
*
* Description : Sets priority of the network core services task.
*
* Argument(s) : prio        New priority for the network service task.
*
*               p_err       Pointer to the variable that will receive one of the following error code(s)
*                           from this function:
*
...
*                                         NetCore_InitModules()
*
* Description : Initialize all the Network modules on the different layers.
*
* Argument(s) : p_mem_seg   Pointer to the memory segment used to allocate network core related data.
...
* Return(s)   : none.
*
* Note(s)     : (2) Ignores configuration functions' return value indicating configuration success/failure.
*********************************************************************************************************
*/
