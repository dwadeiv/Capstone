...
*                                           NetIF_WiFi_Add()
*
* Description : Add & initialize a specific instance of a network WiFi interface.
*
* Argument(s) : p_str_id        String identifier for the WiFi interface to add.
*
*               p_buf_cfg       Pointer to buffer configuration.
*
*               p_ext_cfg       Pointer to extended configuration.
...
*                                          NetIF_WiFi_Start()
*
* Description : (1) Start an WiFi type interface :
*
...
*
*               p_ssid              Pointer to a string that contains the SSID to scan.
