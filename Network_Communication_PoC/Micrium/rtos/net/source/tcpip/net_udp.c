...
*                                            NetUDP_Init()
*
* Description : Initialize User Datagram Protocol Layer.
*
* Argument(s) : none.
*
* Return(s)   : none.
...
*
*               p_data_buf          $$$$ Add description for 'p_data_buf'
*
...
*
*               p_ip_opts_buf       $$$$ Add description for 'p_ip_opts_buf'
*
*               ip_opts_buf_len     Size of IP options receive buffer (in octets)    [see Note #6b].
*
*               p_ip_opts_len       $$$$ Add description for 'p_ip_opts_len'
*
*               p_err               Pointer to variable that will receive the return error code from this function :
*
*                                       RTOS_ERR_NONE
...
*
*               (8) [INTERNAL] Since pointer arithmetic is based on the specific pointer data type & inherent pointer
...
*               data_len        Length  of application data (in octets) [see Note #5].
*
*               p_src_addr      Pointer Source IP address.
*
*               src_port        Source UDP port.
*
*               p_dest_addr     Pointer Destination IP address.
*
*               dest_port       Destination UDP port.
*
...
*
*               flags_udp       Flags to select UDP transmit options (see Note #3); bit-field flags logically OR'd :
*
*               p_err           Pointer to variable that will receive the return error code from this function.
*
* Return(s)   : Number of data octets transmitted, if NO error(s).
...
*                   be called with the global network lock already acquired.
*
*               (3) Some UDP transmit flag options NOT yet implemented :
*
*                   (a) NET_UDP_FLAG_TX_BLOCK
*
*               (4) (a) (1) Datagram transmission & reception MUST be atomic -- i.e. every single, complete
*                           datagram transmitted SHOULD be received as a single, complete datagram.  Thus,
*                           each call to transmit data MUST be transmitted in a single, complete datagram.
*
*                       (2) (A) IEEE Std 1003.1, 2004 Edition, Section 'send() : DESCRIPTION' states that
...
*                   (b) 'data_len' of 0 octets NOT allowed.
*
*               (5) On ANY transmit error, any remaining application data transmit is immediately aborted.
*********************************************************************************************************
*/
#ifdef  NET_IPv6_MODULE_EN
...
*               -----           Argument validated in NetUDP_TxAppDataHandler().
*
*               p_src_addr      Pointer Source IPv6 address.
*
*               src_port        Source UDP port.
*
...
*
* Argument(s) : if_nbr          Interface number on which data will be transmit.
*
